// Import the global dataset of administrative units level 1.
var adminUnits = ee.FeatureCollection(
    'FAO/GAUL_SIMPLIFIED_500m/2015/level1');

// Filter for the Chittagong division by name. Carefully type the name of your study area according to FAO
var adminSelect = adminUnits.filter(ee.Filter.eq('ADM1_NAME', 'Chittagong'));
...
var no2Agg_popWeighted = no2.filterDate('2020-03-01', '2020-04-01')
    .map(getPopWeightedConc(P, adminSelect, 'Chittagong'));
...
var regions = adminUnits
    .filter(ee.Filter.inList('ADM1_NAME', ['Chittagong']));
...
Export.table.toDrive({
    ...
    description: 'no2_popWeighted_Chittagong',
    fileFormat: 'CSV'
});
